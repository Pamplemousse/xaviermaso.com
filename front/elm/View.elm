...
talksView model =
    div []
        [ div [ class "list-component-header" ]
            [ text "As a firm believer in education for everyone, at all times, I sometimes give presentations where I\u{00A0}share knowledge and communicate feedback about things I have explored." ]
        , Html.map TalksMsg
            (TiledList.view
                model.talks
                2
